...
import { addTodo, deleteTodo, setTodoList, updateTodo, completeTodo} from '../Redux/Todo/todoAction';

function TodoList({ categories, todoList, addTodo, updateTodo, deleteTodo, completeTodo }) {
